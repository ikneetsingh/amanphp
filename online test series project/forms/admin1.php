...
<ul id="nav">
	...
	<li class="top"><a href="admin1.php?value=4" id="shop" class="top_link"><span class="down">ComboPack</span></a>
		<ul class="sub">
			<li><a href="admin1.php?value=4">New Combo</a></li>
			<li><a href="admin1.php?value=9">View Combo</a></li>
			
		</ul>
	</li>
	<li class="top"><a href="#nogo57" id="privacy" class="top_link"><span>Assign Test To Combo</span></a>
    <ul class="sub">
			<li><a href="admin1.php?value=5">Assign Test To Combo</a></li>
			<li><a href="admin1.php?value=10">View</a></li>
			</ul>
            </li>
