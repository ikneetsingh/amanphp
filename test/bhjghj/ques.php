...
<table>
<tr><td>Test</td><td><select name="test"><option disabled="disabled" selected="selected" value="">--select--</option>
<?php 
while($row=mysql_fetch_array($str))
{
	echo "<option value='$row[s_sno]'>$row[s_test]</option>";
}
?>
</select></td></tr>
<tr>
...
<td>
answer</td>
            <td>3<input type="text" name="ans3"  value="<?php echo $str1['s_op33']; ?>"/></td>
        </tr>
<tr>
<td>
answer</td>
